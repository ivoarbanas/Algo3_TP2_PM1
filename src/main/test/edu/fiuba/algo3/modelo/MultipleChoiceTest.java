...
public class MultipleChoiceTest {
    ...
    public void seCreaPreguntaMultipleChoiceClasicoIndicandoRespuestaCorrecta() {
        ...
        assertEquals(opcionCorrecta1.valor(),pregunta.opcionesCorrectas().get(0).valor());
        assertEquals(opcionCorrecta2.valor(),pregunta.opcionesCorrectas().get(1).valor());
        assertEquals(opcionCorrecta3.valor(),pregunta.opcionesCorrectas().get(2).valor());
    }
    ...
    public void recibeUnaListaDeRespuestasEnMultipleChoiceClasicoYAsignaPuntosCorrectamente() {
        ...
        //
        jugador1.nuevaRespuesta("Ocho");
        jugador1.nuevaRespuesta("Dieciseis");
        jugador1.nuevaRespuesta("Seis");
        jugador1.nuevaRespuesta("Uno");
